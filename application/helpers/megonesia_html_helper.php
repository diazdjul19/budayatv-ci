...
function render_input($name, $label = '', $value = '', $type = 'text', $form_group_class = '', $input_class = '', $input_attrs = array(), $form_group_attr = array())
{
    $input = '';
    $_form_group_attr = '';
    $_input_attrs = '';
...
function render_date_input($name, $label = '', $value = '', $form_group_class = '', $input_class = '')
{
    $input = '';
    ...
    $input .= '<div class="form-group input-group ' . $form_group_class . '">';

    $input .= '<label for="' . $name . '" class="control-label">' . $label . '</label>';

    $input .= '<input type="text" id="' . $name . '" name="' . $name . '" class="form-control datepicker' . $input_class . '" value="' . $value . '">';
    $input .= '<span class="input-group-addon"><i class="fa fa-calendar"></i></span>';
    $input .= '</div>';
    return $input;
}

function render_textarea($name, $label = '', $value = '', $form_group_class = '', $textarea_class = '', $textarea_attrs = array(), $form_group_attr = array())
{
    $textarea = '';
    $_form_group_attr = '';
    $_textarea_attrs = '';
    ...
    $textarea .= '<textarea id="' . $name . '" name="' . $name . '" class="form-control' . $textarea_class . '" ' . $_textarea_attrs . '>' . $value . '</textarea>';
    $textarea .= '</div>';
    return $textarea;
}
