...
class Anggaran extends MY_Admin
{
    ...
    public function index()
    {
        ...
        $data['css'] = 'css_table';
        $data['menu'] = 'anggaran';
        $data['submenu'] = 'anggaran';


        $data['title'] = "Anggaran";
        $data['button'] = "Anggaran Investasi Baru";
        $data['link'] = "anggaran";
        $data['data'] = $this->anggaran_model->get(1);
    ...
    public function form($id = '')
    {
        ...
        if ($id) {
            $data['title'] = "Update Anggaran Investasi";
            $data['data'] = $this->anggaran_model->get(1, $id);

        }else{
            $data['title'] = "Anggaran Investasi Baru";
        }
    ...
    public function detail($id)
    {
        ...
        $data['title'] = "Anggaran";
        $data['button'] = "Anggaran Investasi";
        $data['link'] = "anggaran";
        $data['data'] = $this->anggaran_model->get(1, $id);
