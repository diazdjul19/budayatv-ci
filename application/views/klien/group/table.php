    ...
    <div class="container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
        <div class="inner">
            ...
            <div class="row">
                ...
                <div class="col">
                    <?php
                    $has_permission = has_permission('klien_group', 'add');
                    if ($has_permission) {
                        ?>
                        <a href="klien_group/form" class="btn btn-primary pull-right">
                            <i class="fa fa-plus"></i>
                            <span class="m-l-10">Group Baru</span>
                        </a>
                    <?php } ?>
                </div>
            </div>
...
<div class="container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
    <div class="card card-transparent ">
        <ul class="nav nav-tabs nav-tabs-fillup" data-init-reponsive-tabs="dropdownfx">
            <li class="nav-item">
                <a href="klien"><span>Daftar Klien</span></a>
            </li>
            <li class="nav-item">
                <a href="klien_group" class="active"><span>Group Klien</span></a>
            </li>
        </ul>
    </div>
