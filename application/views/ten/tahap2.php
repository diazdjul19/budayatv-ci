            ...
            <div class="card card-default">
                ...
                <div class="card-block">
                    <form method="post" action="" role="form" class="myform" autocomplete="off" novalidate>
                        <div class="row">
                            <div class="col-md-12">
                                <p class="m-t-10">Penerimaan BAA</p>
                            </div>
                        </div>
                        <div class="form-group-attached">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <?php echo render_input('pb_tgl_tender', 'Tanggal', $value, 'text', 'form-group-default required', 'datep', ['tabindex' => 4]); ?>
                                </div>
                                <div class="col">
                                    <?php
                                     ...
                                     ?>
                                    <?php echo render_input('pb_jam_tender', 'Jam', $value, 'text', 'form-group-default', 'jam', ['tabindex' => 5]); ?>
                                </div>
                                <div class="col">
                                    <?php echo render_input('pb_tempat_tender', 'Tempat', $data->pb_tempat_tender, 'text', 'form-group-default',  '', ['tabindex' => 6]); ?>
                                </div>
                            </div>
                        </div>
