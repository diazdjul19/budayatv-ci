<div class="container-fluid container-fixed-lg">
    ...
    <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" data-init-reponsive-tabs="dropdownfx">
        ...
        <li class="nav-item">
            <a class="" href="tender/tahap2/<?php echo $data->id_tender ?>"><i class="fa <?php if($data->tahap_tender > 0) echo "fa-check"; else echo "fa-credit-card";?>  tab-icon"></i> <span>Tahap 2</span></a>
        </li>
        <li class="nav-item">
            <a class="" href="<?php if($data->tahap_tender > 0) echo "tender/tahap3/$data->id_tender "; else echo "tender/detail/$data->id_tender "; ?>"><i class="fa <?php if($data->tahap_tender > 1) echo "fa-check"; else echo "fa-credit-card";?> tab-icon"></i> <span>Tahap 3</span></a>
        </li>
    </ul>
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="row m-t-20">
                    <div class="col">
                        <h5><a href="tender/detail/<?php echo $data->id_tender ?>">TOTAL </br> TENDER</a></h5>
                    ...
                    <div class="col">
                        <h5 class="text-success bold"><a href="tender/detail_menang/<?php echo $data->id_tender ?>">TOTAL </br> MENANG</a></h5>
