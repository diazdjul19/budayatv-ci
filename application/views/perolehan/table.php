        ...
        <div class="inner">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    if ($has_permission) {
                        ?>
                        <a href="perolehan/form" class="btn btn-primary pull-right">
                            <i class="fa fa-plus"></i>
                            <span class="m-l-10">Perolehan Baru</span>
                        </a>
                    <?php } ?>
                </div>
            </div>
...
<div class="container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
    <div class="card card-transparent ">
        <ul class="nav nav-tabs nav-tabs-fillup" data-init-reponsive-tabs="dropdownfx">
            ...
            <li class="nav-item">
                <a href="klien"><span>Klien</span></a>
            </li>
            <li class="nav-item">
                <a href="perolehan" class="active"><span>Perolehan</span></a>
            </li>
        </ul>
