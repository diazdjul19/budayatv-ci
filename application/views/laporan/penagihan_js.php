    ...
    $(function () {
        ...
        var datatable = $('#mytable').DataTable({
            ...
            "drawCallback": function(data) {
                ...
                $(api.column(2).footer()).html(data.json.totalProyek);
                $(api.column(3).footer()).html(data.json.totalBq);
                $(api.column(4).footer()).html(data.json.totalBiaya);
