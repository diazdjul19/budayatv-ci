        ...
        <div class="inner">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    if ($has_permission) {
                        ?>
                        <a href="proyek/stlp1" class="btn btn-primary pull-right mb-2"><i class="fa fa-plus mr-2"></i> Tambah Proyek</a>
                        <br>
                        <a href="proyek/tender_menang" class="btn btn-primary pull-right"><i class="fa fa-plus mr-2"></i> Data Menang Tender</a>
                    <?php } ?>
