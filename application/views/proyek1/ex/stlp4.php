                    ...
                    <?php }else{ ?>
                        ...
                        <tr>
                            ...
                            <td class="edit">
                                ...
                                <input type="text" class="edit--date form-control hide" data-id="<?php echo $dt1->id_penagihan ?>" data-jenis="3" value="<?php echo tgl_indo($dt1->tgl_penagihan, 'x', 9) ?>">
                            </td>
                        </tr>
                    <?php }  ?>
                    <form method="post" action="" role="form" class="myform mt-2" autocomplete="off" novalidate>
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td class="edit">
                                ...
                                <input type="text" class="edit--date form-control hide" data-id="<?php echo $d->id_penagihan ?>" data-jenis="3" value="<?php echo tgl_indo($d->tgl_penagihan, 'x', 9) ?>">
                            </td>
                        </tr>
                    <?php $no++; }  ?>
                    <?php
                    ...
                    <?php }else{ ?>
                        ...
                        <tr>
                            ...
                            <td class="edit">
                                ...
                                <input type="text" class="edit--date form-control hide" data-id="<?php echo $dt3->id_penagihan ?>" data-jenis="3" value="<?php echo tgl_indo($dt3->tgl_penagihan, 'x', 9) ?>">
                            </td>
                        </tr>
                    <?php }  ?>
                    <?php
