<div class="container-fluid container-fixed-lg">
                ...
                <div class="row">
                    <div class="col">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">STLP</li>
                        </ol>
                    </div>

                    <div class="col">
                        <a href="proyek" class="btn btn-primary pull-right"><i class="fa fa-chevron-circle-left m-r-10"></i> Kembali</a>
                    </div>
                </div>

            </div>
            <h5><span class="bold">STLP </span>(Status & Time Line Project)</h5>
    ...
    <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist"
        ...
        <li class="nav-item">
            <a class="active text-primary" href="proyek/detail/<?php echo $data->id_proyek ?>">
                <span> STLP</span></a>
        </li>
        <?php if (isset($data)) { ?>
    ...
    <div class="tab-content">
        <ul class="list-inline mt-2 mb-5">
            <li class="list-inline-item">
                <a href="proyek/detail/<?php echo $data->id_proyek ?>"  class="btn btn-tag btn-tag-primary btn-tag-rounded">
                    <span>Detail</span>
                </a>
            </li>
            <?php if (isset($data)) { ?>
                <li class="list-inline-item">
                    <a href="proyek/stlp1/<?php echo $data->id_proyek ?>" class="btn btn-tag btn-tag-rounded">
                        <span>SPK</span>
                    </a>
                </li>
                <li class="list-inline-item">
                    <a href="<?php if ($data->tahap_proyek > 0) echo "proyek/stlp2/$data->id_proyek"; else echo "proyek/stlp1/$data->id_proyek "; ?>"  class="btn btn-tag btn-tag-rounded">
                        <span>BQ</span>
                    </a>
                </li>
                <li class="list-inline-item">
                    <a href="<?php if ($data->tahap_proyek > 0) echo "proyek/stlp3/$data->id_proyek"; else echo "proyek/stlp1/$data->id_proyek "; ?>"  class="btn btn-tag btn-tag-rounded">
                        <span>Uang Muka</span>
                    </a>
                </li>
                <li class="list-inline-item">
                    <a href="<?php if ($data->tahap_proyek > 0) echo "proyek/stlp4/$data->id_proyek"; else echo "proyek/stlp1/$data->id_proyek "; ?>" class="btn btn-tag btn-tag-rounded">
                        <span>Penagihan</span>
                    </a>
                </li>
            <?php } ?>
            ...
            <table class="table table-condensed">
                ...
                <?php if (isset($data)) {
                    if ($data->tahap_proyek > 0) { ?>
                        ...
                        <tr>
                            <td>Masa Retensi</td>
                            <td><?php echo $data->retensi_proyek ?> ( <?php echo tgl_indo(tgl_tambah($data->selesai_proyek, $data->retensi_proyek), 'x', 9)?> )</td>
                        </tr>
                        <tr>
                            <td>Nilai Proyek</td>
                        ...
                        <?php if($data->bq_proyek != 0){?>
                            ...
                            <tr>
                                ...
                                <td>Rp. <?php echo number_format(($data->nilai_proyek - $data->bq_proyek),'2', '.', '.') ?></td>
                            </tr>
                            <tr>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-sm">
                                            ...
                                            foreach($uang as $u){
                                                ?>
                                                <tr>
                                                    <td>Uang Muka <?php echo $no; ?> </br>Rp <?php echo number_format($u->nominal_uang_muka, 2, ',', '.') ?></td>
