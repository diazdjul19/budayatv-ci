        ...
        <div class="card card-default mt-4">
            <div class="card-block">
                ...
                <form action="" method="post">
                    ...
                    <input type="hidden" name="tipe_progress" value="1">
                    ...
                    <?php if (isset($edit)) { ?>
                        <a href="perancangan/progress/<?php echo $data->id_proyek ?>" class="btn btn-default"><i
                    ...
                    if (count($progress)) {
                        ...
                        foreach ($progress as $p) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="perancangan/progress/<?php echo $data->id_proyek ?>/<?php echo $p->id_progress ?>"
                                       class="btn btn-success btn-xs"><i class="fa fa-pencil"></i> </a>
                                    <a href="perancangan/progress_del/<?php echo $p->id_progress ?>/<?php echo $data->id_proyek ?>"
...
<?php } else { ?>
    <div class="col">
        ...
        <a href="perancangan/spk/<?php echo $data->id_proyek ?>">Silahkan input SPK terlebih dahulu.</a>
    </div>
