    ...
    <div class="card card-default mt-4">
        <div class="card-block">
            ...
            <ul class="nav nav-tabs nav-tabs-fillup" data-init-reponsive-tabs="dropdownfx">
                ...
                foreach ($spk as $sp){ ?>
                <li class="nav-item">
                    <a href="perancangan/spk/<?php echo $data->id_proyek ?>/<?php echo $sp->id_spk ?>" class="<?php if(isset($s)) if($sp->id_spk == $s->id_spk) echo "active";?>">
                ...
                <?php if(count($spk)){ ?>
                <li class="nav-item">
                    <a href="perancangan/spk_baru/<?php echo $data->id_proyek ?>" class="<?php if(!isset($s)) echo "active";?>"><i class="fa fa-plus"></i></a>
                </li>
                <?php } ?>
            </ul>
                ...
                <div class="card-block pl-0 pr-0">
                    <form class="mt-2 myform" action="" method="post">
                        ...
                        <div class="row">
                            <div class="col">
                                <?php if(isset($s)){ ?>
                                <a href="perancangan/spk_hapus/<?php echo $data->id_proyek.'/'.$s->id_spk; ?>" class="btn btn-danger mt-3"><i class="fa fa-times mr-2"></i> Hapus</a>
                                <?php } ?>
