    ...
    <div class="card card-default mt-4">
        <div class="card-block">
            ...
            <ul class="nav nav-tabs nav-tabs-fillup" data-init-reponsive-tabs="dropdownfx">
                ...
                foreach ($spk as $sp){ ?>
                <li class="nav-item">
                    <a href="pengawasan/spk/<?php echo $data->id_proyek ?>/<?php echo $sp->id_spk ?>" class="<?php if(isset($s)) if($sp->id_spk == $s->id_spk) echo "active";?>"><span>SPK <?php echo $no; ?></span></a>
                </li>
                <?php
                $no++;
                } }?>
                <?php if(count($spk)){ ?>
                <li class="nav-item">
                    <a href="pengawasan/spk_baru/<?php echo $data->id_proyek ?>" class="<?php if(!isset($s)) echo "active";?>"><i class="fa fa-plus"></i></a>
                </li>
                <?php } ?>
            </ul>
                ...
                <div class="card-block pl-0 pr-0">
                    <form class="mt-2" action="" method="post">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group form-group-default m-0">
                                    ...
                                    <input type="text" name="tgl_spk" class="form-control datep" value="<?php if(isset($s)){ if($s->tgl_spk != '0000-00-00') echo tgl_indo($s->tgl_spk, 'angka', 9); }?>">
                                </div>
                                <div class="form-group form-group-default m-0">
                                ...
                                <div class="form-group form-group-default m-0">
                                    ...
                                    <input type="text" name="bg_jwaktu_spk" class="form-control" value="<?php if(isset($s)) if($s->bg_jwaktu_spk != '0000-00-00') echo $s->bg_jwaktu_spk; ?>">
                                </div>
                                <div class="form-group form-group-default m-0">
                                ...
                                <div class="form-group form-group-default m-0">
                                    ...
                                    <input type="text" name="bg_jwaktu_p_spk" class="form-control" value="<?php if(isset($s)) if($s->bg_jwaktu_p_spk != '0000-00-00') echo tgl_indo($s->bg_jwaktu_p_spk, 'angka', 9); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col">
                                <?php if(isset($s)){ ?>
                                <a href="pengawasan/spk_hapus/<?php echo $data->id_proyek.'/'.$s->id_spk; ?>" class="btn btn-danger mt-3"><i class="fa fa-times mr-2"></i> Hapus</a>
                                <?php } ?>
