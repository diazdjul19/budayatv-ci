                                ...
                                <?php foreach ($jwb as $j) { ?>
                                    <div class="jawab--revisi">
                                        <div class="jawab--user">
                                            <i class="fa fa-user"></i> <?php echo $j->nama_user." ( ".time_ago($j->tgl_revisi_jawab)." )"; ?>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group required">
                                        ...
                                        <select name="status_revisi" class="form-control">
                                            <option value="" <?php if($rev->status_revisi == 0){echo "selected";} ?>></option>
                                            <option value="2" <?php if($rev->status_revisi == 2){echo "selected";} ?>>On Progress</option>
                                            <option value="3" <?php if($rev->status_revisi == 3){echo "selected";} ?>>Selesai</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
